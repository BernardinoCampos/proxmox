...
class Nodes
{
  ...
  */
  static function destroyCephOsd($node, $osdid)
  {
  ...
  /**
    ...
    * @param array    $data
  */
  static function CephOsdIn($node, $osdid, $data = array())
  {
  ...
  /**
    ...
    * @param array    $data
  */
  static function CephOsdOut($node, $osdid, $data = array())
  {
  ...
  /**
    ...
    * @param string   $node     The cluster node name.
  */
  static function getCephPools($node)
  {
  ...
  /**
    ...
    * @param array    $data
  */
  static function createCephPool($node, $data = array())
  {
  ...
  /**
    ...
    * @param string   $node     The cluster node name.
  */
  static function destroyCephPool($node)
  {
  ...
  /**
    ...
    * @param string   $node     The cluster node name.
  */
  static function CephConfig($node)
  {
  ...
  /**
    ...
    * @param string   $node     The cluster node name.
  */
  static function CephCrush($node)
  {
  ...
  /**
    ...
    * @param string   $node     The cluster node name.
  */
  static function CephDisks($node)
  {
  ...
  /**
    ...
    * @param array    $data
  */
  static function createCephInit($node, $data = array())
  {
  ...
  /**
    ...
    * @param integer  $start
  */
  static function CephLog($node, $limit = null, $start = null)
  {
  ...
  /**
    ...
    * @param string   $node     The cluster node name.
  */
  static function CephRules($node)
  {
  ...
  /**
    ...
    * @param array    $data
  */
  static function CephStart($node, $data = array())
  {
  ...
  /**
    ...
    * @param array    $data
  */
  static function CephStop($node, $data = array())
  {
  ...
  /**
    ...
    * @param string   $node     The cluster node name.
  */
  static function CephStatus($node)
  {
  ...
  */
  ...
  /**
    ...
    * @param array    $data
  */
  static function Disk($node, $data = array())
  {
  ...
  /**
    ...
    * @param string   $node     The cluster node name.
  */
  static function disksList($node)
  {
  ...
  */
  static function disksSmart($node, $disk = null)
  {
  ...
  */
  ...
  /**
    ...
    * @param string   $node     The cluster node name.
  */
  static function firewallRules($node)
  {
  ...
  /**
    ...
    * @param array    $data
  */
  static function createFirewallRule($node, $data = array())
  {
  ...
  */
  static function firewallRulesPos($node, $pos)
  {
  ...
  /**
    ...
    * @param array    $data
  */
  static function setFirewallRulePos($node, $pos, $data = array())
  {
  ...
  /**
    ...
    * @param integer  $pos      Update rule at position <pos>.
  */
  static function deleteFirewallRulePos($node, $pos)
  {
  ...
  /**
    ...
    * @param string   $node     The cluster node name.
  */
  static function firewallRulesLog($node)
  {
  ...
  /**
    ...
    * @param string   $node     The cluster node name.
  */
  static function firewallRulesOptions($node)
  {
  ...
  /**
    ...
    * @param array    $data
  */
  static function setFirewallRuleOptions($node, $data = array())
  {
  ...
  */
  ...
  /**
    ...
    * @param array    $data
  */
  static function createLxc($node, $data = array())
  {
  ...
  */
  static function LxcVmid($node, $vmid)
  {
  ...
  /**
    ...
    * @param integer  $vmid     The (unique) ID of the VM.
  */
  static function deleteLxc($node, $vmid)
  {
  ...
  /**
    ...
    * @param integer  $vmid     The (unique) ID of the VM.
  */
  static function lxcFirewall($node, $vmid)
  {
  ...
  /**
    ...
    * @param integer  $vmid     The (unique) ID of the VM.
  */
  static function lxcFirewallAliases($node, $vmid)
  {
  ...
  /**
    ...
    * @param array    $data
  */
  static function createLxcFirewallAliase($node, $vmid, $data = array())
  {
  ...
  */
  static function lxcFirewallAliasesName($node, $vmid, $name)
  {
  ...
  /**
    ...
    * @param array    $data
  */
  static function updateLxcFirewallAliaseName($node, $vmid, $name, $data = array())
  {
  ...
  /**
    ...
    * @param string   $name     Alias name.
  */
  static function deleteLxcFirewallAliaseName($node, $vmid, $name)
  {
  ...
  /**
    ...
    * @param integer  $vmid     The (unique) ID of the VM.
  */
  static function lxcFirewallIpset($node, $vmid)
  {
  ...
  /**
    ...
    * @param array    $data
  */
  static function createLxcFirewallIpset($node, $vmid, $data = array())
  {
  ...
  */
  static function lxcFirewallIpsetName($node, $vmid, $name)
  {
  ...
  /**
    ...
    * @param array    $data
  */
  static function addLxcFirewallIpsetName($node, $vmid, $name, $data = array())
  {
  ...
  /**
    ...
    * @param string   $name     IP set name.
  */
  static function deleteLxcFirewallIpsetName($node, $vmid, $name)
  {
  ...
  */
  static function lxcFirewallIpsetNameCidr($node, $vmid, $name, $cidr)
  {
  ...
  /**
    ...
    * @param array    $data
  */
  static function updateLxcFirewallIpsetNameCidr($node, $vmid, $name, $cidr, $data = array())
  {
  ...
  /**
    ...
    * @param string   $cidr     Network/IP specification in CIDR format.
  */
  static function deleteLxcFirewallIpsetNameCidr($node, $vmid, $name, $cidr)
  {
  ...
  /**
    ...
    * @param integer  $vmid     The (unique) ID of the VM.
  */
  static function lxcFirewallRules($node, $vmid)
  {
  ...
  /**
    ...
    * @param array    $data
  */
  static function createLxcFirewallRules($node, $vmid, $data = array())
  {
  ...
  /**
    ...
    * @param integer  $vmid     The (unique) ID of the VM.
  */
  static function lxcFirewallRulesPos($node, $vmid, $pos)
  {
  ...
  /**
    ...
    * @param array    $data
  */
  static function setLxcFirewallRulesPos($node, $vmid, $pos, $data = array())
  {
  ...
  /**
    ...
    * @param integer  $vmid     The (unique) ID of the VM.
  */
  static function deleteLxcFirewallRulesPos($node, $vmid, $pos)
  {
  ...
  /**
    ...
    * @param integer  $start
  */
  static function lxcFirewallLog($node, $vmid, $limit = null, $start = null)
  {
      $optional['limit'] = !empty($limit) ? $limit : 50;
      $optional['start'] = !empty($start) ? $start : 0;
  ...
  /**
    ...
    * @param integer  $vmid     The (unique) ID of the VM.
  */
  static function lxcFirewallOptions($node, $vmid)
  {
  ...
  /**
    ...
    * @param array    $data
  */
  static function setLxcFirewallOptions($node, $vmid, $data = array())
  {
  ...
  /**
    ...
    * @param integer  $vmid     The (unique) ID of the VM.
  */
  static function lxcSnapshot($node, $vmid)
  {
  ...
  /**
    ...
    * @param array    $data
  */
  static function createLxcSnapshot($node, $vmid, $data = array())
  {
  ...
  */
  static function lxcSnapname($node, $vmid, $snapname)
  {
  ...
  /**
    ...
    * @param string   $snapname     The name of the snapshot.
  */
  static function deleteLxcSnapshot($node, $vmid, $snapname)
  {
  ...
  /**
    ...
    * @param string   $snapname     The name of the snapshot.
  */
  static function lxcSnapnameConfig($node, $vmid, $snapname)
  {
  ...
  /**
    ...
    * @param array    $data
  */
  static function lxcSnapshotConfig($node, $vmid, $snapname, $data = array())
  {
  ...
  /**
    ...
    * @param array    $data
  */
  static function lxcSnapshotRollback($node, $vmid, $snapname, $data = array())
  {
  ...
  /**
    ...
    * @param integer  $vmid     The (unique) ID of the VM.
  */
  static function lxcStatus($node, $vmid)
  {
  ...
  /**
    ...
    * @param integer  $vmid     The (unique) ID of the VM.
  */
  static function lxcCurrent($node, $vmid)
  {
  ...
  /**
    ...
    * @param array    $data
  */
  static function lxcResume($node, $vmid, $data = array())
  {
  ...
  /**
    ...
    * @param array    $data
  */
  static function lxcShutdown($node, $vmid, $data = array())
  {
  ...
  /**
    ...
    * @param array    $data
  */
  static function lxcStart($node, $vmid, $data = array())
  {
  ...
  /**
    ...
    * @param array    $data
  */
  static function lxcStop($node, $vmid, $data = array())
  {
  ...
  /**
    ...
    * @param array    $data
  */
    static function lxcReboot($node, $vmid, $data = array())
  {
    ...
    * @param array    $data
  */
  static function lxcSuspend($node, $vmid, $data = array())
  {
  ...
  /**
    ...
    * @param array    $data
  */
  static function lxcClone($node, $vmid, $data = array())
  {
  ...
  /**
    ...
    * @param integer  $vmid     The (unique) ID of the VM.
  */
  static function lxcConfig($node, $vmid)
  {
  ...
  /**
    ...
    * @param array    $data
  */
  static function setLxcConfig($node, $vmid, $data = array())
  {
  ...
  /**
    ...
    * @param integer  $vmid     The (unique) ID of the VM.
  */
  static function lxcFeature($node, $vmid)
  {
  ...
  /**
    ...
    * @param array    $data
  */
  static function lxcMigrate($node, $vmid, $data = array())
  {
  ...
  /**
    ...
    * @param array    $data
  */
  static function lxcResize($node, $vmid, $data = array())
  {
  ...
  */
  static function lxcRrd($node, $vmid, $ds = null, $timeframe = null)
  {
  ...
  /**
    ...
    * @param enum     $timeframe    Specify the time frame you are interested in.
  */
  static function lxcRrddata($node, $vmid, $timeframe = null)
  {
      $optional['timeframe'] = !empty($timeframe) ? $timeframe : null;
  ...
  /**
    ...
    * @param array    $data
  */
  static function lxcSpiceproxy($node, $vmid, $data = array())
  {
  ...
  /**
    ...
    * @param array    $data
  */
  static function createLxcTemplate($node, $vmid, $data = array())
  {
  ...
  /**
    ...
    * @param array    $data
  */
  static function createLxcVncproxy($node, $vmid, $data = array())
  {
  ...
  */
  static function lxcVncwebsocket($node, $vmid, $port = null, $vncticket = null)
  {
  ...
  */
  static function Network($node, $type = null)
  {
  ...
  /**
    ...
    * @param array    $data
  */
  static function createNetwork($node, $data = array())
  {
  ...
  /**
    ...
    * @param string   $node     The cluster node name.
  */
  static function revertNetwork($node)
  {
  ...
  /**
    ...
    * @param string   $iface
  */
  static function networkIface($node, $iface)
  {
  ...
  /**
    ...
    * @param array    $data
  */
  static function updateNetworkIface($node, $iface, $data = array())
  {
  ...
  /**
    ...
    * @param string   $iface
  */
  static function deleteNetworkIface($node, $iface)
  {
  ...
  */
  ...
  /**
    ...
    * @param array    $data
  */
  static function createQemu($node, $data = array())
  {
  ...
  /**
    ...
    * @param integer  $vmid     The (unique) ID of the VM.
  */
  static function QemuVmid($node, $vmid)
  {
  ...
  /**
    ...
    * @param array    $data
  */
  static function deleteQemu($node, $vmid, $data = array())
  {
  ...
  /**
    ...
    * @param integer  $vmid    The (unique) ID of the VM.
  */
  static function qemuFirewall($node, $vmid)
  {
  ...
  /**
    ...
    * @param integer  $vmid    The (unique) ID of the VM.
  */
  static function qemuFirewallAliases($node, $vmid)
  {
  ...
  /**
    ...
    * @param array    $data
  */
  static function createQemuFirewallAliase($node, $vmid, $data = array())
  {
  ...
  /**
    ...
    * @param string   $name     Alias name.
  */
  static function qemuFirewallAliasesName($node, $vmid, $name)
  {
  ...
  /**
    ...
    * @param array    $data
  */
  static function updateQemuFirewallAliaseName($node, $vmid, $name, $data = array())
  {
  ...
  /**
    ...
    * @param string   $name    Alias name.
  */
  static function deleteQemuFirewallAliaseName($node, $vmid, $name)
  {
  ...
  /**
    ...
    * @param integer  $vmid     The (unique) ID of the VM.
  */
  static function qemuFirewallIpset($node, $vmid)
  {
  ...
  /**
    ...
    * @param array    $data
  */
  static function createQemuFirewallIpset($node, $vmid, $data = array())
  {
  ...
  /**
    ...
    * @param string   $name     IP set name.
  */
  static function qemuFirewallIpsetName($node, $vmid, $name)
  {
  ...
  /**
    ...
    * @param array    $data
  */
  static function addQemuFirewallIpsetName($node, $vmid, $name, $data = array())
  {
  ...
  /**
    ...
    * @param string   $name     IP set name.
  */
  static function deleteQemuFirewallIpsetName($node, $vmid, $name)
  {
  ...
  /**
    ...
    * @param string   $cidr     Network/IP specification in CIDR format.
  */
  static function qemuFirewallIpsetNameCidr($node, $vmid, $name, $cidr)
  {
  ...
  /**
    ...
    * @param array    $data
  */
  static function updateQemuFirewallIpsetNameCidr($node, $vmid, $name, $cidr, $data = array())
  {
  ...
  /**
    ...
    * @param string   $cidr     Network/IP specification in CIDR format.
  */
  static function deleteQemuFirewallIpsetNameCidr($node, $vmid, $name, $cidr)
  {
  ...
  /**
    ...
    * @param integer  $vmid     The (unique) ID of the VM.
  */
  static function qemuFirewallRules($node, $vmid)
  {
  ...
  /**
    ...
    * @param array    $data
  */
  static function createQemuFirewallRules($node, $vmid, $data = array())
  {
  ...
  /**
    ...
    * @param integer  $vmid     The (unique) ID of the VM.
  */
  static function qemuFirewallRulesPos($node, $vmid, $pos)
  {
  ...
  /**
    ...
    * @param array    $data
  */
  static function updateQemuFirewallRulesPos($node, $vmid, $pos, $data = array())
  {
  ...
  /**
    ...
    * @param integer  $vmid     The (unique) ID of the VM.
  */
  static function deleteQemuFirewallRulesPos($node, $vmid, $pos)
  {
  ...
  /**
    ...
    * @param integer  $start
  */
  static function qemuFirewallLog($node, $vmid, $limit = null, $start = null)
  {
      $optional['limit'] = !empty($limit) ? $limit : 50;
      $optional['start'] = !empty($start) ? $start : 0;
  ...
  /**
    ...
    * @param integer  $vmid     The (unique) ID of the VM.
  */
  static function qemuFirewallOptions($node, $vmid)
  {
  ...
  /**
    ...
    * @param array    $data
  */
  static function setQemuFirewallOptions($node, $vmid, $data = array())
  {
  ...
  /**
    ...
    * @param integer  $vmid     The (unique) ID of the VM.
  */
  static function qemuFirewallRefs($node, $vmid)
  {
  ...
  /**
    ...
    * @param integer  $vmid     The (unique) ID of the VM.
  */
  static function qemuSnapshot($node, $vmid)
  {
  ...
  /**
    ...
    * @param array    $data
  */
  static function createQemuSnapshot($node, $vmid, $data = array())
  {
  ...
  /**
    ...
    * @param string   snapname The name of the snapshot.
  */
  static function qemuSnapname($node, $vmid, $snapname)
  {
  ...
  /**
    ...
    * @param string   snapname The name of the snapshot.
  */
  static function deleteQemuSnapshot($node, $vmid, $snapname)
  {
  ...
  /**
    ...
    * @param string   snapname The name of the snapshot.
  */
  static function qemuSnapnameConfig($node, $vmid, $snapname)
  {
    ...
    * @param array    $data
  */
  static function updateQemuSnapshotConfig($node, $vmid, $snapname, $data = array())
  {
  ...
  /**
    ...
    * @param array    $data
  */
  static function QemuSnapshotRollback($node, $vmid, $snapname, $data = array())
  {
  ...
  /**
    ...
    * @param integer  $vmid    The (unique) ID of the VM.
  */
  static function qemuStatus($node, $vmid)
  {
  ...
  /**
    ...
    * @param integer  $vmid    The (unique) ID of the VM.
  */
  static function qemuCurrent($node, $vmid)
  {
  ...
  /**
    ...
    * @param array    $data
  */
  static function qemuResume($node, $vmid, $data = array())
  {
  ...
  /**
    ...
    * @param array    $data
  */
  static function qemuReset($node, $vmid, $data = array())
  {
  ...
  /**
    ...
    * @param array    $data
  */
  static function qemuShutdown($node, $vmid, $data = array())
  {
  ...
  /**
    ...
    * @param array    $data
  */
  static function qemuStart($node, $vmid, $data = array())
  {
  ...
  /**
    ...
    * @param array    $data
  */
  static function qemuStop($node, $vmid, $data = array())
  {
  ...
  /**
    ...
    * @param array    $data
  */
  static function qemuReboot($node, $vmid, $data = array())
  {
  ...
  /**
    ...
    * @param array    $data
  */
  static function qemuSuspend($node, $vmid, $data = array())
  {
  ...
  /**
    ...
    * @param array    $data
  */
  static function qemuAgent($node, $vmid, $data = array())
  {
  ...
  /**
    ...
    * @param array    $data
  */
  static function qemuAgentExec($node, $vmid, $data = array())
  {
  ...
  /**
    ...
    * @param array    $data
  */
  static function qemuAgentSetUserPassword($node, $vmid, $data = array())
  {
  ...
  /**
    ...
    * @param array    $data
  */
  static function qemuClone($node, $vmid, $data = array())
  {
  ...
  /**
    ...
    * @param integer  $vmid    The (unique) ID of the VM.
  */
  static function qemuConfig($node, $vmid)
  {
      return Request::Request("/nodes/$node/qemu/$vmid/config");
  }
  /**
    ...
    * @param array    $data
  */
  static function createQemuConfig($node, $vmid, $data = array())
  {
  ...
  /**
    ...
    * @param array    $data
  */
  static function setQemuConfig($node, $vmid, $data = array())
  {
  ...
  /**
    ...
    * @param integer  $vmid    The (unique) ID of the VM.
  */
  static function qemuFeature($node, $vmid)
  {
  ...
  /**
    ...
    * @param array    $data
  */
  static function qemuMigrate($node, $vmid, $data = array())
  {
  ...
  /**
    ...
    * @param array    $data
  */
  static function qemuMonitor($node, $vmid, $data = array())
  {
  ...
  /**
    ...
    * @param array    $data
  */
  static function qemuMoveDisk($node, $vmid, $data = array())
  {
  ...
  /**
    ...
    * @param integer  $vmid    The (unique) ID of the VM.
  */
  static function qemuPending($node, $vmid)
  {
  ...
  /**
    ...
    * @param array    $data
  */
  static function qemuResize($node, $vmid, $data = array())
  {
  ...
  /**
    ...
    * @param enum     $timeframe   Specify the time frame you are interested in.
  */
  static function qemuRrd($node, $vmid, $ds = null, $timeframe = null)
  {
      $optional['ds'] = !empty($ds) ? $ds : null;
      $optional['timeframe'] = !empty($timeframe) ? $timeframe : null;
  ...
  /**
    ...
    * @param enum     $timeframe   Specify the time frame you are interested in.
  */
  static function qemuRrddata($node, $vmid, $timeframe = null)
  {
      $optional['timeframe'] = !empty($timeframe) ? $timeframe : null;
  ...
  /**
    ...
    * @param array    $data
  */
  static function qemuSendkey($node, $vmid, $data = array())
  {
  ...
  /**
    ...
    * @param array    $data
  */
  static function qemuSpiceproxy($node, $vmid, $data = array())
  {
  ...
  /**
    ...
    * @param array    $data
  */
  static function createQemuTemplate($node, $vmid, $data = array())
  {
  ...
  /**
    ...
    * @param array    $data
  */
  static function qemuUnlink($node, $vmid, $data = array())
  {
  ...
  /**
    ...
    * @param array    $data
  */
  static function createQemuVncproxy($node, $vmid, $data = array())
  {
  ...
  /**
    ...
    * @param string   $vncticket  Ticket from previous call to vncproxy.
  */
  static function qemuVncwebsocket($node, $vmid, $port = null, $vncticket = null)
  {
      $optional['port'] = !empty($port) ? $port : null;
      $optional['vncticket'] = !empty($vncticket) ? $vncticket : null;
  ...
  /**
    ...
    * @param string   $node    The cluster node name.
  */
  static function Replication($node)
  {
  ...
  */
  static function replicationId($node, $id)
  {
  ...
  /**
    ...
    * @param string   $id      Replication Job ID. The ID is composed of a Guest ID and a job number, separated by a hyphen, i.e. '<GUEST>-<JOBNUM>'.
  */
  static function replicationLog($node, $id)
  {
  ...
  /**
    ...
    * @param array    $data
  */
  static function replicationScheduleNow($node, $id, $data = array())
  {
  ...
  /**
    ...
    * @param string   $id      Replication Job ID. The ID is composed of a Guest ID and a job number, separated by a hyphen, i.e. '<GUEST>-<JOBNUM>'.
  */
  static function replicationStatus($node, $id)
  {
  ...
  */
  ...
  /**
    ...
    * @param string   $node    The cluster node name.
  */
  static function scanGlusterfs($node)
  {
  ...
  /**
    ...
    * @param string   $node    The cluster node name.
  */
  static function scanIscsi($node)
  {
  ...
  */
  ...
  /**
    ...
    * @param string   $node    The cluster node name.
  */
  static function scanLvmthin($node)
  {
  ...
  */
  static function listService($node, $service)
  {
  ...
  /**
    ...
    * @param array    $data
  */
  static function servicesReload($node, $service, $data = array())
  {
  ...
  /**
    ...
    * @param array    $data
  */
  static function servicesRestart($node, $service, $data = array())
  {
  ...
  /**
    ...
    * @param array    $data
  */
  static function servicesStart($node, $service, $data = array())
  {
  ...
  /**
    ...
    * @param array    $data
  */
  static function servicesStop($node, $service, $data = array())
  {
  ...
  /**
    ...
    * @param enum     $service  Service ID
  */
  static function servicesState($node, $service)
  {
  ...
  */
  static function Storage($node, $content = null, $storage = null, $target = null, $enabled = null)
  {
  ...
  */
  static function getStorage($node, $storage)
  {
  ...
  /**
    ...
    * @param string   $storage  The storage identifier.
  */
  static function listStorageContent($node, $storage)
  {
  ...
  /**
    ...
    * @param array    $data
  */
  static function storageContent($node, $storage, $data = array())
  {
  ...
  /**
    ...
    * @param string   $storage  The storage identifier.
  */
  static function storageContentVolume($node, $storage, $volume)
  {
  ...
  /**
    ...
    * @param array    $data
  */
  static function copyStorageContentVolume($node, $storage, $volume, $data = array())
  {
  ...
  /**
    ...
    * @param string   $storage  The storage identifier.
  */
  static function deleteStorageContentVolume($node, $storage, $volume)
  {
  ...
  /**
    ...
    * @param string   $storage  The storage identifier.
  */
  static function storageRRD($node)
  {
  ...
  /**
    ...
    * @param string   $storage  The storage identifier.
  */
  static function storageRRDdata($node)
  {
  ...
  /**
    ...
    * @param string   $storage  The storage identifier.
  */
  static function storageStatus($node)
  {
  ...
  /**
    ...
    * @param array    $data
  */
  static function storageUpload($node, $data = array())
  {
  ...
  /**
    ...
    * @param integer  $start
  */
  static function Tasks($node, $errors = null, $limit = null, $vmid = null, $start = null)
  {
  ...
  /**
    ...
    * @param string   $upid
  */
  static function tasksUpid($node, $upid)
  {
  ...
  /**
    ...
    * @param string   $upid
  */
  static function tasksStop($node, $upid)
  {
  ...
  /**
    ...
    * @param integer  $start
  */
  static function tasksLog($node, $upid, $limit = null, $start = null)
  {
      $optional['limit']   = !empty($limit) ? $limit : null;
      $optional['start']   = !empty($start) ? $start : null;
  ...
  /**
    ...
    * @param string   $upid
  */
  static function tasksStatus($node, $upid)
  {
  ...
  /**
    ...
    * @param array    $data
  */
  static function createVzdump($node, $data = array())
  {
  ...
  /**
    ...
    * @param string   $node     The cluster node name.
  */
  static function VzdumpExtractConfig($node)
  {
  ...
  */
  ...
  /**
    ...
    * @param array    $data
  */
  static function downloadTemplate($node, $data = array())
  {
  ...
  */
  ...
  /**
    ...
    * @param array    $data
  */
  static function setDns($node, $data = array())
  {
  ...
  /**
    ...
    * @param array    $data
  */
  static function Execute($node, $data = array())
  {
  ...
  /**
    ...
    * @param array    $data
  */
  static function MigrateAll($node, $data = array())
  {
  ...
  */
  ...
  /**
    ...
    * @param enum     $timeframe    Specify the time frame you are interested in.
  */
  static function Rrd($node, $ds = null, $timeframe = null)
  {
      $optional['ds'] = !empty($ds) ? $ds : null;
      $optional['timeframe'] = !empty($timeframe) ? $timeframe : null;
  ...
  */
  ...
  /**
    ...
    * @param array    $data
  */
  static function SpiceShell($node, $data = array())
  {
  ...
  /**
    ...
    * @param array    $data
  */
  static function StartAll($node, $data = array())
  {
  ...
  /**
    ...
    * @param array    $data
  */
  static function Reboot($node, $data = array())
  {
  ...
  /**
    ...
    * @param array    $data
  */
  static function StopAll($node, $data = array())
  {
  ...
  /**
    ...
    * @param string   $node     The cluster node name.
  */
  static function Subscription($node)
  {
  ...
  /**
    ...
    * @param array    $data
  */
  static function updateSubscription($node, $data = array())
  {
  ...
  /**
    ...
    * @param array    $data
  */
  static function setSubscription($node, $data = array())
  {
  ...
  */
  static function Syslog($node, $limit = null, $start = null, $since = null, $until = null)
  {
      $optional['limit'] = !empty($limit) ? $limit : 50;
      $optional['start'] = !empty($start) ? $start : null;
  ...
  */
  ...
  /**
    ...
    * @param array    $data
  */
  static function setTime($node, $data = array())
  {
  ...
  */
  ...
  /**
    ...
    * @param array    $data
  */
  static function createVNCShell($node, $data = array())
  {
  ...
  /**
    ...
    * @param string   $vncticket  Ticket from previous call to vncproxy.
  */
  static function VNCWebSocket($node, $port = null, $vncticket = null)
  {
      $optional['port'] = !empty($port) ? $port : null;
      $optional['vncticket'] = !empty($vncticket) ? $vncticket : null;
